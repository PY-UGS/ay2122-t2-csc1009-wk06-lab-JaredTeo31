...
public class LinkedList {
    ...
    public static void main(String[] args)
    {
        ...
        llist.push(value);
        llist.sortList();
        System.out.println("Linked List after adding " + value);
        llist.printList();
        System.out.println("Linked List Before Swapping");
        llist.printList();
        llist.swapNodes(3, 11);
        System.out.println("Linked List After Swapping");
        llist.printList();
        LinkedList newlist = new LinkedList();

        for (int i = 1; i <= 500; i++) {
            newlist.push(newlist.randomInt(1000,9999));
        }
        int randomValue = newlist.randomInt(1000,9999);
        int ans = newlist.search(randomValue);
        if (ans == -1) {
            System.out.println(
